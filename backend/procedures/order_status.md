...
**When to use:** the customer is asking where their order is, when it will arrive, or wants tracking details.
...
5. If no orders are found for the email, apologize and hand off using the **Escalation** procedure.
